    ...
    public class ReportService : IReportService
    {
        ...
        public async Task<byte[]> GenerateInventoryStatusReportAsync()
        {
            try
            {
                ...
                if (!items.Any())
                {
                    _logger.LogWarning("⚠ No hay artículos en el sistema");
                    ...
                    container.Page(page =>
                    {
                        ...
                        page.Content()
                            ...
                            .Column(column =>
                            {
                                ...
                                column.Item().Text($" Categorías diferentes: {items.Select(i => i.Category).Distinct().Count()}");
                            });
                ...
                container.Page(page =>
                {
                    ...
                    page.Content()
                        ...
                        .Column(column =>
                        {
                            ...
                            column.Item().Text(" NO HAY DATOS DISPONIBLES").SemiBold().FontSize(16).FontColor(Colors.Orange.Medium);
                            column.Item().PaddingTop(20);
